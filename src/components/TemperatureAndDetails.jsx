    ...
    <div className="flex flex-col text-black items-center justify-center">
      {data.main ? (
        <div className="flex flex-col items-center justify-between gap-2">
          ...
          <p className="text-5xl translate-x-1 -mt-10">{data.main.temp.toFixed()}°</p>
          ...
          <div className="flex items-center justify-around text-md gap-1">
            <div className="flex items-center">
              ...
              Feels like: <span className="font-semibold ml-1">{data.main.feels_like.toFixed()}°</span>
            </div>
          </div>
          <div className="flex items-center justify-around text-md gap-1">
            <div className="flex items-center">
              <UilArrowUp size="22" className="mr-1 -translate-y-0.5" />
              Max: <span className="font-semibold ml-1">{data.main.temp_max.toFixed()}°</span>
            </div>
            <span>|</span>
            <div className="flex items-center">
              <UilArrowDown size="22" className="mr-1 -ml-1 -translate-y-0.5" />
              Min: <span className="font-semibold ml-1">{data.main.temp_min.toFixed()}°</span>
            </div>
          </div>
          <div className="flex items-center justify-around text-md gap-1">
            <div className="flex items-center">
